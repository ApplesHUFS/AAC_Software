...
class FeedbackManager:
    ...
    def _load_from_file(self):
        ...
        try:
            ...
            if self._data.get("feedbacks"):
                self._feedback_id_counter = (
                    max([f["feedback_id"] for f in self._data["feedbacks"]]) + 1
                )
    ...
    def request_interpretation_confirmation(
        self,
        user_id: str,
        cards: List[str],
    ...
    def submit_partner_confirmation(
        self,
        confirmation_id: str,
        ...
        try:
            ...
            if selected_interpretation_index is not None:
                ...
                feedback_result = {
                    ...
                    "selected_interpretation": confirmation_request["interpretations"][
                        selected_interpretation_index
                    ],
